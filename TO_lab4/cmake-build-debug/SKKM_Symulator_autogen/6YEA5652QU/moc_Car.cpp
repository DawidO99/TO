...
void Car::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Car::*)(int , QString )>(_a, &Car::stateChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Car::*)()>(_a, &Car::positionChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void Car::stateChanged(int _t1, QString _t2)
{
